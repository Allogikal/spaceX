<template>
    <div class="letterToSpace">
        ...
        <div class="backText">
            <p>
                Отправьте письмо в космос!
                Это может быть что угодно: вопрос про жизнь на орбите,
                признание в любви, интересные факты. Космонавты
                прочитают все и запишут ответ на понравившиеся письма.
            </p>
        </div>
    </div>
</template>
